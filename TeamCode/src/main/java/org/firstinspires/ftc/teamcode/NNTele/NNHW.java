...
public class NNHW {
    ...
    public void Forward(double speed, double distance){
        LF.setTargetPosition((int) (-distance * COUNTS_PER_INCH));
        LR.setTargetPosition((int) (-distance * COUNTS_PER_INCH));
        RF.setTargetPosition((int) (-distance * COUNTS_PER_INCH));
        RR.setTargetPosition((int) (-distance * COUNTS_PER_INCH));
    ...
    public void Reverse(double speed, double distance){
        LF.setTargetPosition((int) (distance* 1 *  COUNTS_PER_INCH));
        LR.setTargetPosition((int) (distance* 1 *  COUNTS_PER_INCH));
        RF.setTargetPosition((int) (distance* 1 * COUNTS_PER_INCH));
        RR.setTargetPosition((int) (distance* 1 * COUNTS_PER_INCH));
        LF.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        LR.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        RF.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        RR.setMode(DcMotor.RunMode.RUN_TO_POSITION);
